...
实现四模板注册、文案与视觉规划双分支、页面级图片生成、Mock Provider、统一 API 和部分成功语义。

## 对应范围

- Goals：G-2—G-5
- Success Criteria：SC-2—SC-5、SC-7、SC-8
- Requirements：FR-4—FR-11、FR-15—FR-18、NFR-2—NFR-4、NFR-6、NFR-7
